...
addToMapIfDefined( 'a11y_wireNode_accessibleParagraphPattern', 'a11y.wireNode.accessibleParagraphPatternStringProperty' );
  ...
  a11y: {
    ...
    formulaNode: {
      ...
      accessibleParagraphPattern: {
        ...
        noneComparable: new FluentPattern<{ rToA: FluentVariable, rToL: FluentVariable, rToRho: FluentVariable }>( fluentSupport.bundleProperty, 'a11y_formulaNode_accessibleParagraphPattern_noneComparable', _.get( ResistanceInAWireStrings, 'a11y.formulaNode.accessibleParagraphPattern.noneComparableStringProperty' ), [{"name":"rToA"},{"name":"rToL"},{"name":"rToRho"}] )
      },
    ...
    wireNode: {
      ...
      accessibleParagraphPattern: new FluentPattern<{ impurities: 'tiny' | 'verySmall' | 'small' | 'medium' | 'large' | 'veryLarge' | 'huge' | TReadOnlyProperty<'tiny' | 'verySmall' | 'small' | 'medium' | 'large' | 'veryLarge' | 'huge'>, length: 'extremelyShort' | 'veryShort' | 'short' | 'medium' | 'long' | 'veryLong' | 'extremelyLong' | TReadOnlyProperty<'extremelyShort' | 'veryShort' | 'short' | 'medium' | 'long' | 'veryLong' | 'extremelyLong'>, resistance: FluentVariable, thickness: 'extremelyThin' | 'veryThin' | 'thin' | 'medium' | 'thick' | 'veryThick' | 'extremelyThick' | TReadOnlyProperty<'extremelyThin' | 'veryThin' | 'thin' | 'medium' | 'thick' | 'veryThick' | 'extremelyThick'> }>( fluentSupport.bundleProperty, 'a11y_wireNode_accessibleParagraphPattern', _.get( ResistanceInAWireStrings, 'a11y.wireNode.accessibleParagraphPatternStringProperty' ), [{"name":"impurities","variants":["tiny","verySmall","small","medium","large","veryLarge","huge"]},{"name":"length","variants":["extremelyShort","veryShort","short","medium","long","veryLong","extremelyLong"]},{"name":"resistance"},{"name":"thickness","variants":["extremelyThin","veryThin","thin","medium","thick","veryThick","extremelyThick"]}] ),
